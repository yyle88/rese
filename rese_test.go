...
func TestV7(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7 := rese.V7(run())
	require.Equal(t, "a", v1)
	require.Equal(t, uint64(2), v2)
	require.Equal(t, 'x', v3)
	require.Equal(t, int32(42), v4)
...
func TestV8(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7, v8 := rese.V8(run())
	require.Equal(t, "a", v1)
	require.Equal(t, uint64(2), v2)
	require.Equal(t, 'x', v3)
	require.Equal(t, int32(42), v4)
...
func TestV9(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7, v8, v9 := rese.V9(run())
	require.Equal(t, "a", v1)
	require.Equal(t, uint64(2), v2)
	require.Equal(t, 'x', v3)
	require.Equal(t, int32(42), v4)
...
func TestP7(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7 := rese.P7(run())
...
func TestP8(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7, v8 := rese.P8(run())
...
func TestP9(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7, v8, v9 := rese.P9(run())
...
func TestC7(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7 := rese.C7(run())
...
func TestC8(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7, v8 := rese.C8(run())
...
func TestC9(t *testing.T) {
	...
	v1, v2, v3, v4, v5, v6, v7, v8, v9 := rese.C9(run())
